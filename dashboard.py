...
st.title("📦 Interactive Product Recommendation System Dashboard")
st.markdown("""
Welcome! This dashboard guides you through an end-to-end exploratory data analysis (EDA) and recommendation system for product ratings data.
""")
